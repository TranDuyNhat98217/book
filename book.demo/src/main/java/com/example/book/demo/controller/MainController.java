...
//    }z
    ...
    public ResponseEntity<String> createBook(@RequestBody Book newBook) {
        try {
            ...
            return new ResponseEntity<>("Book created successfully.",
                    HttpStatus.CREATED);
        } catch (Exception e) {
...
public ResponseEntity<String> deleteBook(@RequestParam(name="isbn") String
                                                   isbn) {
        try {
...
public ResponseEntity<String> updateBook(@RequestBody Book book) {
        try {
            ...
            return new ResponseEntity<>("Book updated successfully.",
                    HttpStatus.OK);
            } catch (Exception e) {
            return new ResponseEntity<>(e.getMessage(), HttpStatus.BAD_REQUEST);
             }
        ...
        @GetMapping("/get-book")
public ResponseEntity<Book> getBook(@RequestParam(name = "isbn") String
                                               isbn) {
